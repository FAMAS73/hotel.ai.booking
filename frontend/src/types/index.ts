/**
 * TypeScript Type Definitions for Hotel AI Booking Chatbot Frontend
 *
 * This file contains all TypeScript interfaces and types used throughout the application.
 * Types are organized by domain and include inline documentation for thesis demonstration.
 *
 * Aligned with backend API response structures from FastAPI endpoints.
 *
 * @module types
 * @version 1.0.0
 */
